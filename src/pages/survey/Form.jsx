      ...
      */}
      ...
      >
         ...
         <div className="text-center mb-4 md:mb-8">
          ...
          <h1 className="text-2xl md:text-4xl font-bold text-gray-800 mb-1 md:mb-2">Formulario de {category_name}</h1>
          <p className="text-sm md:text-base text-gray-600">Sus respuestas nos ayudan a mejorar la salud y bienestar de los estudiantes de UniValle</p>
        </div>

        {/* We use a loop, so we'll add spacing and borders to each fieldset */}
        {questions.map((q) => {
          ...
          switch (q.question_type) {
            case "unique_response":
              return (
                // Each question is in a fieldset, now with bottom border and padding
                <fieldset
                  key={q.id}
