    ...
    <>
      {addTrigger && (
        <div className="p-4 sm:p-6 md:p-8">
          <h2 class="text-4xl font-bold dark:text-white text-black mb-10">Sesiónes</h2>
                  ...
                  <div className="mt-2 space-y-2 text-sm text-slate-500">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <a
                        ...
                        target="_blank"
                        // Security measure for opening links in a new tab
                        rel="noopener noreferrer"
                        // Styling to make it look like a clickable link
