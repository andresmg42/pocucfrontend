    ...
    return (
      <div className="flex items-center justify-center">
        <Placeholder1
          ...
          onButtonClick={() => setAddTriggerVisit(!addTriggerVisit)}
        />
      </div>
    );
    ...
    <>
      {addTriggerVisit && (
        <div className="p-4 sm:p-6 md:p-8">
          <h2 class="text-4xl font-bold dark:text-white text-black mb-10">Visitas</h2>
              ...
              `}
                  ...
                  <div className="mt-3 space-y-2 text-sm text-slate-500">
                    <div className="flex items-center gap-2">
                      ...
                      <span>Fecha: {visit.visit_date}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      {/* Icon for Time */}
                      <svg
                      ...
                      <span>
                        Hora: {visit.start_time} - {visit.end_time}
                      </span>
                    </div>
                  </div>
                </div>
