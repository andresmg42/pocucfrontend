...
export default function DeniedAccessPlaceholder() {
  return (
    <div className="flex items-center justify-center w-full h-full p-4  rounded-lg">
      <div className="w-full max-w-lg p-8 text-center bg-white border-2 border-dashed border-gray-300 rounded-xl shadow-sm">
        ...
        <p className="mt-2 text-gray-600">
          Usted no tiene los permisos necesarios para ver este contenido. Por
          Favor contacte a soporte técnico si cree que hay algún error.
        </p>

        <div className="px-4 py-3 mt-6 text-sm text-yellow-800 bg-yellow-100 border border-yellow-300 rounded-lg">
          <span className="font-semibold">Nota:</span> Solamente los usuarios
          con un rol de <span className="font-semibold">Administrador</span>{" "}
          Pueden acceder a este reporte.
        </div>
      </div>
    </div>
  );
